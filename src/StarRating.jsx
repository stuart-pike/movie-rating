...
StarRating.propTypes = {
  ...
  onSetRating: PropTypes.func, //outside state
};

// Use equal sign when destructuring to set a default in case no value is passed
  ...
  return (
    <div>
      <StarRating
        maxScale={5}
        color="orangered"
        messages={["Terrible", "Bad", "Okay", "Good", "Excellect"]}
        onSetRating={setMovieRating}
      />
      <p>This movie was rated {movieRating} out of 5 stars</p>
    </div>
  );
}
{
